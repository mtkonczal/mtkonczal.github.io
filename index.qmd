...
You can find the full list of his [writing and media](#portfolio) below. You can read his newsletter [here](https://newsletter.mikekonczal.com/).
:::
:::

::: {#latest .mk-recent__heading}
Latest Things
:::
...
![](images/image-803426826.png){.mk-book-cover fig-align="center" width="220" fig-alt="Freedom from the Market book cover"}
...
"Freedom from the Market has the potential to be a very important book, focusing attention on the contested, messy but crucially important intersection between social movements and the state. [...] Strongly recommended."\
