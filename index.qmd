...
I enjoy trying to make the most informative graphics for the monthly economic data releases while sharing the R code.

```{r ridgeline, out.width="100%",fig.height=10}
#| code-fold: true
