...
<div class="mk-projects">
  <a class="mk-project" href="tidyusmacro.html">
    ...
    <div class="mk-project__body">
      ...
      <p class="mk-project__desc">An R package that downloads and tidies U.S. macroeconomic data from BLS, BEA, and FRED flat files, returning consistent data frames ready for modeling and graphics minutes after a release goes live.</p>
