...
Hello testing! I write for a variety of publications, both popular and academic. Below is a list of columns and op-eds, policy and research papers, and book reviews. Feel free to contact me if you'd like me to write for you.
...
my_data <- read_csv("data/mywork.csv") %>%
  ...
  select(Year, Month, Outlet, Title = title)
